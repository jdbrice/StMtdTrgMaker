...
class StMTDTrgMaker : public StMaker {
	...
	private:
		...
		struct EVENT{
			...
			UShort_t sumBbqEastVpd[11];
			UShort_t sumBbqWestVpd[11];
			UShort_t sumADCBbqEastVpd[11];
			UShort_t sumADCBbqWestVpd[11];
			UShort_t nGoodBbqEastVpd[11];
			UShort_t nGoodBbqWestVpd[11];
