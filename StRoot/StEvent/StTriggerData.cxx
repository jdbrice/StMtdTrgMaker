...
unsigned short StTriggerData::vpdNGoodHit(StBeamDirection eastwest, int prepost) const {return 0;}
unsigned short StTriggerData::vpdSumTac(StBeamDirection eastwest, int prepost) const {return 0;}
