...
public:
    ...
    virtual unsigned short vpdNGoodHit(StBeamDirection eastwest, int prepost=0) const;
    virtual unsigned short vpdSumTac(StBeamDirection eastwest, int prepost=0) const;
