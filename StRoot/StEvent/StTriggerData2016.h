...
public:
    ...
    unsigned short vpdNGoodHit(StBeamDirection eastwest, int prepost=0) const;
    unsigned short vpdSumTac(StBeamDirection eastwest, int prepost=0) const;
    ...
    unsigned short bbcVP101(int ch, int prepost) const;
